  ...
  return (
    <div className="font-normal font-['Poppins']">
      ...
      {isVisible && badges && (
        ...
        <div
          ref={popupRef}
          className="absolute w-48 h-52 right-2 mt-2 max-h-80 overflow-y-auto bg-white border-t-[3px] border-pink-500 rounded-bl-2xl rounded-br-2xl shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] z-10 p-3 flex flex-row">
            
          {/* Left Side */}
          <div className="flex flex-col w-1/2 items-center justify-start space-y-2">
            {/* Right Title - Total Points */}
